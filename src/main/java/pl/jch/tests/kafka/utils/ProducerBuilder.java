...
public class ProducerBuilder {
     ...
     */
    public ProducerBuilder avroSerializerautoRegisterSchemas(boolean autoRegisterSchemas) {
     ...
     */
    public ProducerBuilder avroSerializeravroReflectionAllowNull(boolean avroReflectionAllowNull) {
     ...
     */
    public ProducerBuilder avroSerializeravroRemoveJavaProperties(boolean avroRemoveJavaProperties) {
     ...
     */
    public ProducerBuilder avroSerializeravroUseLogicalTypeConverters(boolean avroUseLogicalTypeConverters) {
     ...
     * and SASL_INHERIT
     */
    public ProducerBuilder avroSerializerbasicAuthCredentialsSource(String basicAuthCredentialsSource) {
     ...
     */
    public ProducerBuilder avroSerializerbasicAuthUserInfo(String basicAuthUserInfo) {
     ...
     */
    public ProducerBuilder avroSerializerbearerAuthCredentialsSource(String bearerAuthCredentialsSource) {
     ...
     */
    public ProducerBuilder avroSerializerbearerAuthToken(String bearerAuthToken) {
     ...
     */
    public ProducerBuilder avroSerializerkeySubjectNameStrategy(Class<?> keySubjectNameStrategy) {
     ...
     */
    public ProducerBuilder avroSerializerlatestCompatibilityStrict(boolean latestCompatibilityStrict) {
     ...
     */
    public ProducerBuilder avroSerializermaxSchemasPerSubject(int maxSchemasPerSubject) {
     ...
     * instances.
     */
    public ProducerBuilder avroSerializerproxyHost(String proxyHost) {
     ...
     */
    public ProducerBuilder avroSerializerproxyPort(int proxyPort) {
     ...
     */
    public ProducerBuilder avroSerializerschemaReflection(boolean schemaReflection) {
     ...
     * Specify the user info for Basic Auth in the form of {username}:{password}
     */
    public ProducerBuilder avroSerializerschemaRegistryBasicAuthUserInfo(String schemaRegistryBasicAuthUserInfo) {
     ...
     * network protocol. By default all the available cipher suites are supported.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslCipherSuites(String schemaRegistrySslCipherSuites) {
     ...
     * `ssl.protocol`.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslEnabledProtocols(String schemaRegistrySslEnabledProtocols) {
     ...
     * The endpoint identification algorithm to validate server hostname using server certificate.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslEndpointIdentificationAlgorithm(String schemaRegistrySslEndpointIdentificationAlgorithm) {
     ...
     * objects. Default value is org.apache.kafka.common.security.ssl.DefaultSslEngineFactory
     */
    public ProducerBuilder avroSerializerschemaRegistrySslEngineFactoryClass(Class<?> schemaRegistrySslEngineFactoryClass) {
     ...
     * This is required for clients only if two-way authentication is configured.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslKeyPassword(String schemaRegistrySslKeyPassword) {
     ...
     * factory algorithm configured for the Java Virtual Machine.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslKeymanagerAlgorithm(String schemaRegistrySslKeymanagerAlgorithm) {
     ...
     * supports only PEM format with a list of X.509 certificates
     */
    public ProducerBuilder avroSerializerschemaRegistrySslKeystoreCertificateChain(String schemaRegistrySslKeystoreCertificateChain) {
     ...
     * 'ssl.key.password'
     */
    public ProducerBuilder avroSerializerschemaRegistrySslKeystoreKey(String schemaRegistrySslKeystoreKey) {
     ...
     * authentication for client.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslKeystoreLocation(String schemaRegistrySslKeystoreLocation) {
     ...
     * 'ssl.keystore.location' is configured.  Key store password is not supported for PEM format.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslKeystorePassword(String schemaRegistrySslKeystorePassword) {
     ...
     * The file format of the key store file. This is optional for client.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslKeystoreType(String schemaRegistrySslKeystoreType) {
     ...
     * 'TLSv1.3'.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslProtocol(String schemaRegistrySslProtocol) {
     ...
     * provider of the JVM.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslProvider(String schemaRegistrySslProvider) {
     ...
     * The SecureRandom PRNG implementation to use for SSL cryptography operations.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslSecureRandomImplementation(String schemaRegistrySslSecureRandomImplementation) {
     ...
     * factory algorithm configured for the Java Virtual Machine.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslTrustmanagerAlgorithm(String schemaRegistrySslTrustmanagerAlgorithm) {
     ...
     * supports only PEM format with X.509 certificates.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslTruststoreCertificates(String schemaRegistrySslTruststoreCertificates) {
     ...
     * The location of the trust store file.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslTruststoreLocation(String schemaRegistrySslTruststoreLocation) {
     ...
     * format.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslTruststorePassword(String schemaRegistrySslTruststorePassword) {
     ...
     * The file format of the trust store file.
     */
    public ProducerBuilder avroSerializerschemaRegistrySslTruststoreType(String schemaRegistrySslTruststoreType) {
     ...
     */
    public ProducerBuilder avroSerializerschemaRegistryUrl(String schemaRegistryUrl) {
     ...
     */
    public ProducerBuilder avroSerializeruseLatestVersion(boolean useLatestVersion) {
     ...
     */
    public ProducerBuilder avroSerializervalueSubjectNameStrategy(Class<?> valueSubjectNameStrategy) {
