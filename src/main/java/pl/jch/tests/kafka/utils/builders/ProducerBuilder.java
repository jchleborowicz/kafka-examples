...
public class ProducerBuilder {
    ...
    public <KeyT, ValueT> OutgoingRecordsProducerBuilder<KeyT, ValueT> defineOutgoingRecordsProducer() {
        return OutgoingRecordsProducerBuilder.builder(this::buildAndExecute);
    }
    ...
    public <KeyT, ValueT, ResultT> ResultT buildAndExecute(ProducerCallback<KeyT, ValueT, ResultT> callback) {
    ...
    public <KeyT, ValueT> void buildAndExecute(ProducerCallbackVoid<KeyT, ValueT> callback) {
        buildAndExecute((ProducerCallback<KeyT, ValueT, Void>) producer -> {
